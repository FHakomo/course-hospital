                    ...
                    <div class="container-fluid">
                        ...
                        <div class="collapse navbar-collapse" id="navbarSupportedContent">
                            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link" href="/diagnoses">Діагностування</a>
                                </li>
        ...
        <div class="row">
            <div class="col-md-4">
                <div class="list-group">
                    ...
                    <a href="/patients" class="list-group-item list-group-item-action">Усі пацієнти</a>
                    <a href="#" class="list-group-item list-group-item-action">Мої пацієнти</a>
